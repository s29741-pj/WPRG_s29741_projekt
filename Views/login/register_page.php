...
$reg_success = $msg->get_flash('register_success');
?>
...
<div class="flex flex-col justify-around bg-white w-1/4 h-1/2 p-10 rounded-lg shadow-lg">
    ...
    <?php if($reg_success){echo "<div class='text-center text-green-600'> $reg_success </div>";}?>
    <form action="index.php?route=register" method="POST" class="h-full flex flex-col justify-around items-center">
