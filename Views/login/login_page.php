...
<div class="flex flex-col justify-around bg-white w-1/4 h-1/2 p-10 rounded-lg shadow-lg">
    ...
    <form action="index.php?route=login" class="h-full flex flex-col justify-around items-center" method="POST">
        <label for="username">
    ...
    <form action="index.php?route=login/guest" method="POST" class="h-20 flex flex-col justify-around items-center">
        <label for="guest">
    ...
    <form action="index.php" method="GET" class="h-20 flex flex-col justify-around items-center">
        <input type="hidden" name="route" value="forgotten">
    ...
    <form action="index.php" method="GET"  class="h-20 flex flex-col justify-around items-center">
        <input type="hidden" name="route" value="register_page">
