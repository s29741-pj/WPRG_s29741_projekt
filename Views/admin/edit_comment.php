...
<div class="container mx-auto mt-10">
    ...
    <form action="index.php?route=admin/comments/edit" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8">
        ...
        <a href="index.php?route=admin/comments" class="text-gray-700 underline ml-4">Cancel</a>
    </form>
</div>
</body>
</html>