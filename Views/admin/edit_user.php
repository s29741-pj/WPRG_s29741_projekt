...
<div class="container mx-auto mt-10">
    ...
    <form action="<?= url('/admin/users/edit')?>" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8">
        ...
        <select name="role_id" class="w-full border px-4 py-2 mb-4">
            <option value="1" <?= $user->getUserRole() == 1 ? 'selected' : '' ?>>Admin</option>
            <option value="2" <?= $user->getUserRole() == 2 ? 'selected' : '' ?>>User</option>
        </select>
        ...
        <a href="<?=url('/admin/users')?>" class="text-gray-700 underline ml-4">Cancel</a>
    </form>
</div>
</body>
</html>